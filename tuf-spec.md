...
discuss next.
  ...
  ::
    A list of <a>HEX_DIGEST</a>s used to succinctly describe a set of target
    paths. Specifically, each <a>HEX_DIGEST</a> in <a>"path_hash_prefixes"</a>
    ...
    (<dfn>HEX_DIGEST</dfn>), must share the same prefix as one of the prefixes
